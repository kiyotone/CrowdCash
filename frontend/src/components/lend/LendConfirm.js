...
function LendConfirm(props) {
  ...
  return (
    ...
    >
      <div className="w-[30rem] h-[32rem] p-8 flex flex-col rounded-md text-white bg-[#333] gap-3">
        <div className="border p-4 pb-10 rounded-lg">
          <div className="flex items-center flex-col">
            <Image src={photo} className="w-12 h-12 bg-white rounded-full" />
            <div className="font-bold text-2xl">
              {lend.author.firstname} {lend.author.lastname}
            </div>
          </div>
          <div className="">
        ...
        <div className="flex justify-center">
          <button
            ...
            className="bg-[#2c8b35] p-3 mt-4 rounded-full items-center "
          >
            Get This Lend
          </button>
        </div>
